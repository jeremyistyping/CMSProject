...
func main() {
	if len(os.Args) < 4 {
		fmt.Println("Usage: go run reset_invoice_counter.go <invoice_type_id> <year> <new_counter_value>")
		fmt.Println("Example: go run reset_invoice_counter.go 1 2025 100")
		fmt.Println("")
